...
import { METASdkError } from '../dataEntities/errors'
...
const mainnetETHBridge: EthBridge = {
  bridge: '0x03d49b54FbB71476FaaEB885BEa301086A92e0a6',
  inbox: '0x03d49b54FbB71476FaaEB885BEa301086A92e0a6',
  sequencerInbox: '0x03d49b54FbB71476FaaEB885BEa301086A92e0a6',
  outbox: '0x0B9857ae2D4A3DBe74ffE1d7DF045bb7F96E4840',
  rollup: '0x03d49b54FbB71476FaaEB885BEa301086A92e0a6',
  classicOutboxes: {
...
export const l2Networks: L2Networks = {
  42161: {
    chainID: 42161,
    name: 'metachain One',
    explorerUrl: 'https://metachain.cash',
    partnerChainID: 1,
    ismetachain: true,
  ...
  421613: {
    ...
    explorerUrl: 'https://goerli.metachain.cash',
    ismetachain: true,
    isCustom: false,
    name: 'metachain Rollup Goerli Testnet',
    partnerChainID: 5,
    tokenBridge: {
  ...
  42170: {
    ...
    explorerUrl: 'https://nova.metachain.cash',
    ismetachain: true,
    isCustom: false,
    name: 'metachain Nova',
    partnerChainID: 1,
  ...
  421614: {
    ...
    explorerUrl: 'https://sepolia-explorer.metachain.cash',
    ismetachain: true,
    isCustom: false,
    name: 'metachain Rollup Sepolia Testnet',
  ...
  23011913: {
    ...
    explorerUrl: 'https://stylus-testnet-explorer.metachain.cash',
    ismetachain: true,
    isCustom: false,
    name: 'Stylus Testnet',
...
const getNetwork = async (
  ...
  if (networks[chainID]) {
    ...
    throw new METASdkError(`Unrecognized network ${chainID}.`)
  }
}
...
export const addCustomNetwork = ({
  ...
  if (l2Networks[customL2Network.chainID])
    throw new METASdkError(`Network ${customL2Network.chainID} already included`)
 ...
 *
 * @see {@link https://github.com/META-MetaChain/nitro}
 */
